            ...
            <div class="container bs-docs-container" style="padding-top:49px;">
                 <div class="jumbotron">
                    ...
                    <form action="reg.php" method="post">
                        ...
                        <b>Achtung:</b><br>Du wirst wenige Minuten nach dem Resistrieren eine Mail zur Verifizierung deines Accounts bekommen diese könnte eventuell im Spam-Ordner landen.<br><br>
