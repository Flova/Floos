            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="profile.php?p=<?php $homeid2 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  profile WHERE administraedFrom = {$_SESSION['userid']} AND type = 1");
$homeid12 = mysqli_fetch_assoc($homeid2);
echo $homeid12['id'];?>">
                                Mein Profil</a>
                        </li>
                        <li>
            ...
            <div class="col-md-12 hidden-md hidden-lg">
                ...
                <form action="home.php" method="post">
                    <div class="input-group">
                        <input class="form-control" type="text" value="Dein Status" name="pinnwand" style="width:100%;"
...
?>
            ...
            <div class="col-md-10" style="padding-left:5; background-color:#e9e9e9;">
                <div class="col-md-12 hidden-xs hidden-sm">
                    ...
                    <form action="home.php" method="post">
                        <div class="input-group">
                            <input class="form-control" type="text" value="Dein Status" name="pinnwand"
                                style="width:100%;" onFocus="if(this.value == 'Dein Status') this.value = ''"
                                onBlur="if(this.value == '') this.value = 'Dein Status'" />
                            <div class="input-group-btn">
                                <button class="btn btn-default" type="submit">Senden</button>
                            </div>
