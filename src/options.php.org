...
if(isset($_POST['passwort'])) {
	$pw3 = mysql_real_escape_string($_POST['passwort']);
	$update = mysql_query("UPDATE `user` SET `password` = MD5( '" . $pw3 . "' ) WHERE `id` = " . $_SESSION['userid']);
}
			...
			<div id="content" style="background-image:none;padding-left:0px; padding-top:50px;">
		        ...
		        <div class="col-md-10">
		        	<h2>Einstellungen</h2>
	           		<div class='panel panel-default'>
		            	...
		            	<div class="panel-body">
							<form action="options.php" method="post" class="form-inline" role="form">        
								<div class="form-group" style="margin-right:10px;">
									<input name="passwort" type="password" placeholder="Password" id="exampleInputPassword2" class="form-control">
								</div>
        			...
        			<div class='panel panel-default'>
		            	...
		            	<div class="panel-body">
							<p>Um eine Person oder einen Bug zu Melden, seinen Account zu Löschen oder &auml;hnliches, kontaktieren Sie bitte den Admin:<br>E-Mail: flori@flova.de oder tyll@flova.de</p>
		            	</div>
        			</div>
   				</div>
    		</div>
