 <head>
     ...
     <!-- Bootstrap core CSS -->
     <link rel="stylesheet" href="http://flova.de/floos_debug/sonstiges/css/bootstrap.min.css">

     <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
     <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
     <script src="http://flova.de/floos_debug/sonstiges/js/ie-emulation-modes-warning.js"></script>

     <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
     <script src="http://flova.de/floos_debug/sonstiges/js/ie10-viewport-bug-workaround.js"></script>
