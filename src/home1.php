...
<body>
    <div id="root">
        <div id="logo"></div>
        <div id="sub-navi"><form action="serach.php" method="get">
        <input type="search" value="Suche" name="s" style="right:10px; float:left; width:162px;" onfocus="if(this.value == 'Suche') this.value = ''" onBlur="if(this.value == '') this.value = 'Suche'">	  	<?php echo $friendship_request; ?><a href="profile.php?p=<?php echo $userProfile['id']; ?>">Mein Profil</a><a>  </a><a href="logout.php">Logout </a> </form> </div>
        <div id="content">
            <div id="navi">
